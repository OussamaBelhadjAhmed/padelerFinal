...
public class ReservationtionUserController implements Initializable {
    ...
    private void refreshClubTable() {
        ...
        try {
            ...
            if (idUser != 0) {
                reservationList.addAll(rs.readAllJoinTerrainAndClub(idUser));
                ...
                public void updateItem(String item, boolean empty) {
                    ...
                    if (empty) {
                        ...
                        prinnt.setOnMouseClicked((MouseEvent event) -> {
                            ...
                            try {
                                System.out.println("immmmm here priiinnntttt");
                                reservation = clubsTable.getSelectionModel().getSelectedItem();
                                System.out.println("reservation : " + reservation.getTerrain().getName());
                                print(event);
                            } catch (Exception ex) {
